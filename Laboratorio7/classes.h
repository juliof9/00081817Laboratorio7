...
enum parameters {TAU, KAPPA , LAMBDA, IPSILON, PSI , DELTHA, ETA};
...
class mesh{
    ...
    public:
        void setParameters(float tau,float kappa, float lambda, float ipsilon, float psi, float deltha, float eta){
            parameters[TAU]=tau;
